...
public class AlexaDao extends DbAccessBase {

	public AlexaDao(Connection conn) {
		super(conn);
	}
	 ...
	 * @throws SQLException
	 */
	public List<AlexBean> getAlexas(int startRow,int groupRow) throws SQLException{
		AlexBean bean = new AlexBean(startRow,groupRow);
