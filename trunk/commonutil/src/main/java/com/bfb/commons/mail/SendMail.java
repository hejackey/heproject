...
public class SendMail{
    ...
    public SendMail()
    {
        ...
        isHtml = false;
        auth = false;
        vfile = new Vector<String>(10, 10);
    }

    /**
    * 电子邮件发送的构造函数
    * @param smtphost smtp服务器的网址或IP地址
    * @param from 发信地址
    * @param to 目的地址
    * @param cc 抄送
    * @param bcc 密送
    * @param subject 电子邮件的标题
    *
    */
    public SendMail(String smtphost, String from, String to, String cc, String bcc, String subject)
    {
        messagetext.setLength(0);
        debug = false;
        isHtml = false;
    ...
    * @param bcc 密送
    * @param subject 电子邮件的标题
    * @param username SMTP认证的username
    * @param password SMTP认证的password
    *
    */
    public SendMail(String smtphost, String from, String to, String cc, String bcc, String subject, String username,
            String password)
    {
        messagetext.setLength(0);
        debug = false;
    ...
    /**
     * 设置SMTP服务器的IP地址或域名
     * @param smtphost SMTP服务器的IP地址或域名
     */
    ...
    public boolean send()
    {
        ...
        try
        {
            ...
            if(!isHtml)
            {
                msg.setText(messagetext.toString(), "gb2312");
    ...
    public static void main(String[] args)
    {
        for(int i = 0; i < 1; i++)
        {
          SendMail mail = new SendMail("smtp.yeah.net", "saf@yeah.net", "asdf@gmail.com", "sdf@yeah.net", "", "New HTML Mail !!!! ", "sdf", "12345678");
