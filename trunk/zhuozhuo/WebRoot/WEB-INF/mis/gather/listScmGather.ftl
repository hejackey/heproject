...
<div id="rightcontent">
	<div id="breadcrumb">
    	您所在的位置：<a href="#" class="green">首页</a> > <a href="listStockOrder.do" class="green">采购单列表</a>  > <span class="fb black">采购单列表</span>
    </div>    
    ...
    <div id="container">
     <div class="addsell">
   	  ...
   	  <input type="button" onclick="updateState(1,'aid','updateStatusStockOrder')" class="btn120x28" style="cursor:pointer" id="checksheet" name="checksheet" value="审核单据">
