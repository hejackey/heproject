  ...
  <body>
    <form action="saveUser.do" method="post">
    	<table align="center" bgcolor="#008800" border="0" cellspacing="2" cellpadding="3" width="600">
		    <tr bgcolor="#CCCCCC">
		    	<td colspan="2" align="center">新用户</td>
		    </tr>
		    <tr bgcolor="#FFFF88">
		    	<td>Name: <@spring.bind	"command.name"/></td>
		    	<td>
		    		<input type="text" name="name" value="${spring.status.value?default("")}"/>
		    ...
		    <tr bgcolor="#FFFF88">
		    	...
		    	<td>
		    		<input type="text" name="mail" value="${spring.status.value?default("")}"/>
		    		<@spring.showErrors "", "color:red;"/>
		    	</td>
		    </tr>
		    <tr bgcolor="#FFFF88">
		    	...
		    	<td>
		    		<input type="text" name="telephone" value="${spring.status.value?default("")}"/>
		    		<@spring.showErrors "", "color:red;"/>
		    	</td>
		    </tr>		    
		    <tr bgcolor="#FFFF88" >
		    	<td colspan="2" align="left">
		    		<div>
						...
						<!--<iframe id="content___Frame" frameborder="0" height="400" scrolling="no" width="600" src="/fckeditor/fckeditor/editor/fckeditor.html?InstanceName=content&amp;Toolbar=Basic"> </iframe>-->
