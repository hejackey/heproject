...
<div id="rightcontent">
	<div id="breadcrumb">
    	您所在的位置：<a href="#" class="green">首页</a> > <a href="#" class="green">调拨单列表</a>  > <span class="fb black">
    ...
    <div class="addsell">
    	...
    	<div class="right textright"><a href="listdiaoBoDao.do?stockopentype=${model.stockopentype?if_exists}" class="green fb">返回上一级</a></div>
    </div>
    <div class="clear"></div>
    <!--上边功能区开始-->
      ...
      <div class="clear"></div>
    <!--上边功能区结束-->
    <form name="form1" method="post" action="savediaoBoDao.do">
    	...
    	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="selldetail">
          <tr>
            ...
            <td width="16%">
             ...
             <img src="../images/calendar.gif" onclick="queryProvider()" style="cursor:pointer;">    
            ...
            <td width="7%" class="header fb">调拨部门</td>
            <td width="18%">
          ...
          <tr>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="productTable">
              <tr>
                ...
                <th scope="col" class="tabheader02" width="10%">调拨单价（含税）</th>
              ...
              <tbody id="td_row">
              <#if model.diaoBoDaoDetailList?if_exists?size!=0>
              <#list model.diaoBoDaoDetailList?if_exists as list>
              <tr bgcolor="#f9ffe2" class="trclass">
                <td class="seq">${list_index?if_exists+1}</td>
                <td>
                <input type="hidden" name="diaoBoDaoDetail.aproductid" id="productid${list_index?if_exists+1}" class="sellinput" value="${list.productid?if_exists}"/>
                ...
                <td><input type="text" name="diaoBoDaoDetail.aqty" id="amount${list_index?if_exists+1}" title="${list_index?if_exists+1}" onchange="calSumPrice(${list_index?if_exists+1})" value="${list.qty?if_exists}" class="sellinput amount" /></td>
                <td><input type="text" name="diaoBoDaoDetail.afactinprice" id="productpurchase${list_index?if_exists+1}" title="${list_index?if_exists+1}" onchange="calSumPrice(${list_index?if_exists+1})" value="${list.factinprice?if_exists}" class="productpurchase sellinput" /></td>
                <td><input type="text" name="diaoBoDaoDetail.ataxrate" id="taxrate${list_index?if_exists+1}" title="${list_index?if_exists+1}" onchange="calSumPrice(${list_index?if_exists+1})" value="${list.factinprice?if_exists}" class="sellinput taxrate" /></td>
                <td><input type="text" name="diaoBoDaoDetail.aamt" id="sumprice${list_index?if_exists+1}" readonly class="sellinput sumprice" value="${list.taxrate?if_exists}"/></td>
                ...
                <td align="center"><input type="text" name="diaoBoDaoDetail.aremark" id="remark${list_index?if_exists+1}" readonly class="sellinput remark" value="${list.remark?if_exists}"/></td>
              ...
              <tr bgcolor="#f9ffe2" class="trclass">
                <td class="seq">1</td>
                <td>
                <input type="hidden" name="diaoBoDaoDetail.aproductid" id="productid1" class="sellinput" value=""/>
                ...
                <td><input type="text" name="diaoBoDaoDetail.aqty" id="amount1" title="1" onchange="calSumPrice(1)"  class="sellinput amount" /></td>
                <td><input type="text" name="diaoBoDaoDetail.afactinprice" id="productpurchase1" title="1" onchange="calSumPrice(1)" class="productpurchase sellinput" /></td>
                <td><input type="text" name="diaoBoDaoDetail.ataxrate" id="taxrate1" title="1" onchange="calSumPrice(1)" class="sellinput taxrate" /></td>
                <td><input type="text" name="diaoBoDaoDetail.aamt" id="sumprice1" readonly class="sellinput sumprice" value=""/></td>
                <td><input name="productentry" type="text" class="sellinput productentry1" readonly id="productentry" value="" /></td>
                <td align="center"><input type="text" name="diaoBoDaoDetail.aremark" id="remark1" readonly class="sellinput remark" /></td>
                <td align="center" class="nb_right"><a href="javascript:;" onclick="removetr(this)"><img src="../images/icon_del.gif" width="16" height="16" title="删除该条信息" /></a></td>
              </tr>
              <tr bgcolor="#ffffdf" class="trclass">
                <td class="seq">2</td>
                <td>
                <input type="hidden" name="diaoBoDaoDetail.aproductid" id="productid2" class="sellinput"/>
                ...
                <td><input type="text" name="diaoBoDaoDetail.aqty" id="amount2" title="2" onchange="calSumPrice(2)" class="sellinput" /></td>
                <td><input type="text" name="diaoBoDaoDetail.afactinprice" id="productpurchase2" title="2" onchange="calSumPrice(2)" class="sellinput" /></td>
                <td><input type="text" name="diaoBoDaoDetail.ataxrate" id="taxrate2" title="2" onchange="calSumPrice(2)" class="sellinput" /></td>
                <td><input type="text" name="diaoBoDaoDetail.aamt" id="sumprice2" readonly class="sellinput" /></td>
                <td><input name="productentry" type="text" readonly class="sellinput" id="productentry2" value="" /></td>
                <td align="center"><input type="text" name="diaoBoDaoDetail.aremark" readonly id="remark2" class="sellinput" /></td>
              ...
              <tr bgcolor="#f9ffe2" class="trclass">
                <td class="seq">3</td>
                <td>
                <input type="hidden" name="diaoBoDaoDetail.aproductid" id="productid3" class="sellinput"/>
                ...
                <td><input type="text" name="diaoBoDaoDetail.aqty" id="amount3" title="3" onchange="calSumPrice(3)" class="sellinput" /></td>
                <td><input type="text" name="diaoBoDaoDetail.afactinprice" id="productpurchase3" title="3" onchange="calSumPrice(3)" class="sellinput" /></td>
                <td><input type="text" name="diaoBoDaoDetail.ataxrate" id="taxrate3" title="3" onchange="calSumPrice(3)" class="sellinput" /></td>
                <td><input type="text" name="diaoBoDaoDetail.aamt" id="sumprice3"readonly  class="sellinput" /></td>
                <td><input name="productentry" type="text" class="sellinput" readonly id="productentry3" value="" /></td>
                <td align="center"><input type="text" name="diaoBoDaoDetail.aremark" id="remark3" readonly class="sellinput" /></td>
                <td align="center" class="nb_right"><a href="javascript:;" onclick="removetr(this)"><img src="../images/icon_del.gif" width="16" height="16" title="删除该条信息" /></a></td>
              </tr>             
              </#if>
              </tbody>
          ...
          <tr>
            <td align="center" colspan="10" height="40">
                <#if model.id?if_exists!="">
	                <#if model.auditid?if_exists=="">
		            <input type="button" class="btn48x22 fl_left" onclick="editdiaoBoDao()" style="cursor:pointer" id="editdiaoBoDao" name="editdiaoBoDao" value="修改"/>
		            </#if>            
	            <#else>
	            <input type="button" class="btn48x22 fl_left" onclick="savediaoBoDao()" style="cursor:pointer" id="savediaoBoDao" name="savediaoBoDao" value="保存"/>
	            </#if>
            </td>
          </tr>
        </table>
