...
function formCheck(){					
		...
		document.forms[0].action="${contextPath}/mis/providerType/saveProviderType.do";
...
<div id="rightcontent">
	<div id="breadcrumb">
    	您所在的位置：<a href="#" class="green">首页</a> > <a href="#" class="green">菜单名称</a>  > <span class="fb black">供应商类别录入</span>
    </div>
    <div id="container">
	    <div class="addsell">
	   		<div class="left currentname fb">增加供应商分类</div>        
    	...
    	<!--上边功能区结束-->
			    ...
			    <!--详细开始-->
			    <form action="${contextPath}/mis/providerType/saveProviderType.do" method="post">
