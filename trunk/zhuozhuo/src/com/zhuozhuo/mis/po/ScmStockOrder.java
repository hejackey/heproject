...
public class ScmStockOrder extends BaseModel {
	/**
	 * 
	 */
	...
	private ScmStockOrderDetail stockOrderDetail = new ScmStockOrderDetail();
	private List<ScmStockOrderDetail> stockOrderDetailList;
	private List<ScmStockOrder> stockOrderList;	
	...
	public ScmStockOrderDetail getStockOrderDetail() {
		return stockOrderDetail;
	}
	public void setStockOrderDetail(ScmStockOrderDetail stockOrderDetail) {
	...
	public List<ScmStockOrder> getStockOrderList() {
		return stockOrderList;
	}
	public void setStockOrderList(List<ScmStockOrder> stockOrderList) {
	...
	public List<ScmStockOrderDetail> getStockOrderDetailList() {
		return stockOrderDetailList;
	}
	public void setStockOrderDetailList(
			List<ScmStockOrderDetail> stockOrderDetailList) {
