...
public class RandomUtil
{
	...
	public static void main(String[] args) {
		RandomUtil.setCharset("a-z");
		// 指定字符内容为"0"-"z"，当然也可以是别的��比如"a-z"或"A-Z"
		RandomUtil.setLength("6"); // 指定字符长度
		try {
			RandomUtil.generateRandomObject();// 生成随机数
		} catch (Exception e) {
			// TODO 自动生成 catch 块
			e.printStackTrace();
		}
		System.out.println(RandomUtil.getRandom());// 得到一个随机数
