...
public class PhoneDataService1 extends DataBaseService {
...
//	}
	...
	public List<Document> getUnSalePhonePhoneDatas(int beginNum, int endNum) {
	    ...
	    sql.append(" or t.productclass = 1 and t.ifvalid = 0 " );
...
//					market_time, phoneFun.toString().trim(), productModel, keywords, color,brandv.intValue(), ifuse);
	...
	public static void main(String arg[]) {
		PhoneDataService1 peijianDataService = new PhoneDataService1();
