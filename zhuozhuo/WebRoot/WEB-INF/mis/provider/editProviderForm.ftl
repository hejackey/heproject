...
function formCheck(){	
		...
		document.forms[0].action="${contextPath}/mis/provider/updateProvider.do";
...
<div id="rightcontent">
	<div id="breadcrumb">
    	您所在的位置：<a href="#" class="green">首页</a> > <a href="#" class="green">菜单名称</a>  > <span class="fb black">修改供应商</span>
    </div>
    <div id="container">
	    <div class="addsell">
	   		<div class="left currentname fb">修改商品供应商</div>        
    	...
    	<!--上边功能区结束-->
			    ...
			    <!--详细开始-->
			    <form action="${contextPath}/mis/provider/updateProvider.do" method="post">
			    <input type="hidden" name="id" id="id" value="${command.id?default('')}">				    		    
			    <div class="selllist">
			    	<table width="90%" border="0" cellspacing="0" cellpadding="0" class="selldetail" align="center">
			          <tr>
			            ...
			            <td width="35%">
			            	<@spring.formInput "command.providerCode",'onblur=TextChange(this,document.forms[0].goodsTypeCode)' />
		    				<@spring.showErrors "", "color:red;"/>			            	
			            </td>            
			          </tr>
			          <tr>
