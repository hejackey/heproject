...
<script type="text/javascript" src="../js/gather/gather.js"></script>
</head>

<body>
<div id="rightcontent">
	<div id="breadcrumb">
    	您所在的位置：<a href="#" class="green">首页</a> > <a href="#" class="green">收款单列表</a>  > <span class="fb black">
    ...
    <div class="addsell">
    	...
    	<div class="right textright"><a href="listScmGather.do?stockopentype=${model.stockopentype?if_exists}" class="green fb">返回上一级</a></div>
    </div>
    <div class="clear"></div>
    <!--上边功能区开始-->
      ...
      <div class="clear"></div>
    <!--上边功能区结束-->
    <form name="form1" method="post" action="saveScmGather.do">
    ...
    <div class="selllist">
    	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="selldetail">
          <tr>
            ...
            <td width="7%" class="header fb">收款部门</td>
            <td width="18%">
          ...
          <tr>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="productTable">
              <tr>
                ...
                <th scope="col" class="tabheader02" width="10%">数量（收款/退货）</th>
                <th scope="col" class="tabheader02" width="10%">收款单价（含税）</th>
          ...
          <tr>
            <td align="center" colspan="10" height="40">
                <#if model.id?if_exists!="">
		            ...
		            <input type="button" class="btn48x22 fl_left" onclick="editScmGather()" style="cursor:pointer" id="editscmgather" name="editscmgather" value="修改"/>
		            </#if>            
	            <#else>
	            <input type="button" class="btn48x22 fl_left" onclick="saveScmGather()" style="cursor:pointer" id="savescmgather" name="savescmgather" value="保存"/>
	            </#if>
            </td>
          </tr>
        </table>
