...
function formCheck(){
		...
		document.forms[0].action="${contextPath}/mis/productInfoJxc/updateProductInfoJxc.do";
...
<div id="rightcontent">
	<div id="breadcrumb">
    	您所在的位置：<a href="#" class="green">首页</a> > <a href="#" class="green">菜单名称</a>  > <span class="fb black">更新商品</span>
    </div>
    <div id="container">
	    <div class="addsell">
    	...
    	<!--上边功能区结束-->
			    ...
			    <!--详细开始-->
			    <form action="${contextPath}/mis/productInfoJxc/updateProductInfoJxc.do" method="post">
