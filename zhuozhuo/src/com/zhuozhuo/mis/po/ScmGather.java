...
public class ScmGather extends BaseModel {
	/**
	 * 
	 */
	...
	private ScmGatherDetail scmGatherDetail = new ScmGatherDetail();
	private List<ScmGatherDetail> scmGatherDetailList;
	private List<ScmGather> scmGatherList;	
	...
	public ScmGatherDetail getScmGatherDetail() {
		return scmGatherDetail;
	}
	public void setScmGatherDetail(ScmGatherDetail scmGatherDetail) {
		this.scmGatherDetail = scmGatherDetail;
	}
	...
	public List<ScmGather> getScmGatherList() {
		return scmGatherList;
	}
	public void setScmGatherList(List<ScmGather> scmGatherList) {
		this.scmGatherList = scmGatherList;
	}
	...
	public List<ScmGatherDetail> getScmGatherDetailList() {
		return scmGatherDetailList;
	}
	public void setScmGatherDetailList(
			List<ScmGatherDetail> scmGatherDetailList) {
		this.scmGatherDetailList = scmGatherDetailList;
	}
