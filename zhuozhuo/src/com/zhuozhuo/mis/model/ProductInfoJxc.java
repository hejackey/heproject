...
public class ProductInfoJxc {	
	...
	//商品单位
	private String productUnit;//商品单位(jxc)	varchar2(100)
	//商品规格
	private String productSpecs;//商品规格(jxc)	varchar2(50)	50
	//商品类型
	private String productType;//商品类型(jxc)	varchar2(600)	600
	//商品性能
	private String productProperty;//商品性能(jxc)	varchar2(50)	50
	//商品重量
	private Double productWeight ;//商品重量(jxc)	number	
	//商品体积
	private Double productVolume ;//商品体积#商品pk商品#(jxc)	number
	//商品颜色
	private String productCorlor;//商品颜色(jxc)	varchar2(50)	50
	//商品尺寸
	private String porductSize;//商品尺寸(jxc)	varchar2(50)	50
	//实际库存
	...
	//商品增值
	private Double productIncrement ;//商品增值(jxc)	number	
	//有效期
